...
import com.tantuni.zamazon.controllers.adapters.UserAdapter;
...
public class AdminHomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressBarHome = (ProgressBar) rootView.findViewById(R.id.progressBarAdminHome);
        recyclerViewUsers = (RecyclerView) rootView.findViewById(R.id.recyclerViewUsers);
        AdminController.getAllUsers(getContext(), new UserCallback<List<User>>() {
            @Override
            public void onSuccess(List<User> users, String message) {
